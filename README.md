...
## Purpose
Controller to create scripts with templates and manage scripts

## Usage
```
scriptctl [COMMAND] [COMMAND_OPTION]
Controller to manage scripts.

Commands:
  create      Create new script with template
